const CLEARSPACE_VERSION = '1.3.4';
    ...
    this.innerHTML = `
      ...
      <div class="editor">
        <div class="row">
          ...
          <input data-field="entity" type="text" value="${escapeHtml(this._config.entity || '')}" placeholder="sensor.clearspace_tasks" />
          <div class="hint">Use the ClearSpace task sensor for the account you want to show.</div>
        </div>
        <div class="row">
