const CLEARSPACE_VERSION = '1.3.5';
    ...
    this.innerHTML = `
      ...
      <div class="editor">
        <div class="row">
          ...
          <div class="hint">Choose the ClearSpace task sensor for the account you want to show. If no sensors are discovered yet, you can type one manually.</div>
        </div>
        <div class="row">
